...
import io.camunda.scenario.Scenario;
...
import static io.camunda.scenario.Scenario.hasActiveElement;
import static org.mockito.Mockito.*;

@SpringBootTest
@CamundaSpringProcessTest
class ProcessScenarioStyleTests {
    ...
    @BeforeEach
    void configureMocks() {
        scenario = Scenario.create(client);
    ...
    void shouldCreateAccountWithSubscription() {
        ...
        scenario.when(hasActiveElement("Await email activation")).then(
                () -> client
